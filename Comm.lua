--Global strings for COMM:
WoHo.COMMPREFIX = "WoHo";

WoHo.COMM_MSG_CLIENT_INFO = format("%s: %s","MyClient",GetAddOnMetadata("WorldOfHearthOh","Version"));
...
function WoHo:COMM_GameRequested(source)
	print(format("%s requested a game with you! [Nothing here yet.]",source));
end;